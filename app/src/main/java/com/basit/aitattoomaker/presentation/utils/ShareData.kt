...
val style_list: ArrayList<StyleItem> = arrayListOf(
    StyleItem("1", "Fire", R.drawable.dragon,false,true,"file:///android_asset/tattoos/tattoo.png"),
    StyleItem("2", "Dragon", R.drawable.dragon,false,false,"file:///android_asset/tattoos/dragon.png"),
    StyleItem("3", "Flower", R.drawable.dragon,true,false,"file:///android_asset/tattoos/flower.png"),
    StyleItem("4", "Heart", R.drawable.dragon,false,false,"file:///android_asset/tattoos/heart.png"),
    StyleItem("5", "Sparrow", R.drawable.dragon,false,false,"file:///android_asset/tattoos/sparrow.png")
)
